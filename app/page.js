...
export default function Plugin() {
    ...
    const onStreamToCanvas = () => __awaiter(this, void 0, void 0, function* () {
        ...
        const createOrUpdateTextNode = () => __awaiter(this, void 0, void 0, function* () {
            ...
            nodeID = yield figmaAPI.run((figma_1, _a) => __awaiter(this, [figma_1, _a], void 0, function* (figma, { nodeID, text, textPosition }) {
                var _b, _c;
                ...
                if (!node) {
                    ...
                    node.x = (_b = textPosition === null || textPosition === void 0 ? void 0 : textPosition.x) !== null && _b !== void 0 ? _b : 0;
                    node.y = (_c = textPosition === null || textPosition === void 0 ? void 0 : textPosition.y) !== null && _c !== void 0 ? _c : 0;
                }
                if (node.type !== "TEXT") {
                    return "";
                }
